...
### Summary statistics
```{r summary, fig.width=10, dpi=300, cache=T}
...
```{r ar_pops, out.width="80%", dpi=300, cache=T}
setPop(obj) <- ~Country/Pop
...
```{r ar_country, out.width="80%", dpi=300, cache=T}
setPop(obj) <- ~Country
...
```{r ca, fig.width=5, dpi=300, cache=T}
...
genepop - LD
ia - LD
test.within - hierarchical Fst - goudet 2005
- 
